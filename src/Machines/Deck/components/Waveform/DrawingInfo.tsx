...
import {WAVEFORM_CANVAS_WIDTH} from "../../consts";
...
export const DrawingInfo: React.FC<DrawingInfoProps> = ({length}) => {
    ...
    return <Box alignSelf={'center'} position={'absolute'} p={'9'} width={`${WAVEFORM_CANVAS_WIDTH}px`}>
        <Text as={'p'} align={'center'} size={'4'}>Generating waveform image.</Text>
        <Text as={'p'} align={'center'} size={'2'}>This may take about {duration} sec.</Text>
